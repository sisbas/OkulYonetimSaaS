...
export class CreateIdentityTeacherReferenceFoundation1785000000000 implements MigrationInterface {
  name = 'CreateIdentityTeacherReferenceFoundation1785000000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      BEGIN
        ...
        END IF;
        IF EXISTS (
          SELECT tenant_id, id FROM courses GROUP BY tenant_id, id HAVING count(*) > 1
        ) THEN
