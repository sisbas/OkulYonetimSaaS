...
export const OPERATIONS_COMPONENT_SKELETONS: readonly OperationsComponentDescriptor[] = [
  ...
  },
  {
    ...
    roleBoundaryNote: 'Management placeholders may see draft surfaces; Teacher own-read and Viewer read-only only see published projection placeholders.',
    apiBinding: 'not_connected',
    permissionBinding: 'pending_catalog',
    interactionEnabled: false,
    submitEnabled: false,
  ...
  },
  {
    ...
    doesNotDisplay: OPERATIONS_FUTURE_RENDER_BLOCKLIST,
    contractDependencies: SCHEDULE_CONTRACT_DEPENDENCIES,
    roleBoundaryNote: 'Teacher own-read projection cannot expose other-teacher events, drafts, unpublished schedules or branch discovery.',
    apiBinding: 'not_connected',
    permissionBinding: 'pending_catalog',
    interactionEnabled: false,
    submitEnabled: false,
  ...
  },
  {
    ...
    route: '/app/schedule',
    stateCoverage: ['empty', 'error', 'forbidden', 'contract_pending'],
    contractStateCoverage: ['validation_invalid', 'validation_stale'],
    displays: [
  ...
  },
  {
    ...
    route: '/app/schedule',
    stateCoverage: ['empty', 'error', 'forbidden', 'contract_pending'],
    contractStateCoverage: ['publish_confirmation', 'publish_blocked'],
    displays: [
    ...
    doesNotDisplay: OPERATIONS_FUTURE_RENDER_BLOCKLIST,
    contractDependencies: SCHEDULE_CONTRACT_DEPENDENCIES,
    roleBoundaryNote: 'Publish and unpublish are management-only placeholders; no confirmation action is enabled.',
    apiBinding: 'not_connected',
    permissionBinding: 'pending_catalog',
    interactionEnabled: false,
    submitEnabled: false,
  ...
  },
  {
    ...
    contractStateCoverage: ['validation_stale', 'version_mismatch', 'version_required'],
    displays: [
    ...
    doesNotDisplay: OPERATIONS_FUTURE_RENDER_BLOCKLIST,
    contractDependencies: SCHEDULE_CONTRACT_DEPENDENCIES,
    roleBoundaryNote: 'No automatic retry, merge or mutation is attempted after 412 or 428 contract states.',
    apiBinding: 'not_connected',
    permissionBinding: 'pending_catalog',
    interactionEnabled: false,
    submitEnabled: false,
