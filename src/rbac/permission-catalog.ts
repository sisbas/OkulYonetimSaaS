...
export const PHASE_1_PERMISSION_CATALOG: readonly PermissionCatalogEntry[] = [
  ...
  {
    key: 'tenant_admin.report.student.read',
    role: 'tenant_admin',
  ...
  {
    key: 'tenant_admin.report.guardian.read',
    role: 'tenant_admin',
    route: '/reports/guardians',
    action: 'read',
    resource: 'report.guardian',
    permission: 'report:guardian:read',
    effect: 'allow',
    audit_required: true,
    deny_state: 'blocked_kvkk',
  },
  {
    key: 'tenant_admin.report.attendance.read',
    role: 'tenant_admin',
    route: '/reports/attendance',
    action: 'read',
    resource: 'report.attendance',
  ...
  {
    key: 'tenant_admin.report.course.read',
    role: 'tenant_admin',
    route: '/reports/courses',
    action: 'read',
    resource: 'report.course',
