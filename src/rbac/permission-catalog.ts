...
export const PHASE_1_PERMISSION_CATALOG: readonly PermissionCatalogEntry[] = [
  ...
  {
    key: 'teacher.leave.own.detail.read',
    role: 'teacher',
    route: '/leave-requests/:requestId',
    action: 'read',
    resource: 'leave_request.own',
    permission: 'leave:own:read',
    effect: 'allow',
  ...
  {
    key: 'operations.leave.detail.read',
    role: 'operations_manager',
    route: '/leave-requests/:requestId',
    action: 'read',
    resource: 'leave_request',
  ...
  {
    key: 'operations.leave.impact.read',
    role: 'operations_manager',
    route: '/leave-requests/:requestId/impact',
    action: 'read',
    resource: 'leave_request.impact',
    permission: 'leave:impact:read',
    effect: 'allow',
    audit_required: false,
    deny_state: 'masked',
  },
  {
    key: 'operations.leave.approve',
    role: 'operations_manager',
  ...
  {
    key: 'tenant_admin.leave.detail.read',
    role: 'tenant_admin',
    route: '/leave-requests/:requestId',
    action: 'read',
    resource: 'leave_request',
  ...
  {
    key: 'tenant_admin.leave.impact.read',
    role: 'tenant_admin',
    route: '/leave-requests/:requestId/impact',
    action: 'read',
    resource: 'leave_request.impact',
  ...
  {
    key: 'tenant_admin.leave.approve',
    role: 'tenant_admin',
    route: '/leave-requests/:requestId/approve',
    action: 'approve',
    resource: 'leave_request',
