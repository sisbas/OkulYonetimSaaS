...
Kişisel veri, öğrenci, veli, guardian, personel, notification payload, production audit log veya uygulama verisi etkilenmez. Değişiklik yalnız GitHub PR body semantic validation, check-run simulation ve governance contract test davranışını etkiler.
